        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-10 py-4 sticky top-0 z-50">
                <div class="flex items-center gap-3 flex-wrap">
                    ...
                    <h2 class="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em] border-l border-slate-300 dark:border-slate-700 pl-4"><?= $isNewStay ? 'Nueva Estancia / New Internship' : 'Registro de Personal / Personnel Registration' ?></h2>
                </div>
            </header>
