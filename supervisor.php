...
// ObtÃ©n el nombre de grupo desde group_name (nuevo) o grupo (legacy)
...
<body class="bg-background-light dark:bg-background-dark min-h-screen text-slate-900 dark:text-slate-100">
            ...
            <main class="flex-1 flex justify-center pt-36 md:pt-28 pb-10 px-4 md:px-0">
                <div class="w-full max-w-[980px] flex flex-col gap-8">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">Administra tu grupo y aprueba nuevas solicitudes de incorporaciÃ³n</p>
                    </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">InformaciÃ³n de tu estancia en el grupo</p>
                        </div>
                    ...
                    <div id="requestsSection" style="display: none;" class="flex flex-col gap-4">
                        <div>
                            ...
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Nuevas solicitudes de incorporaciÃ³n al grupo</p>
                        </div>
    ...
    <script>
        ...
        function renderSupervisorCard() {
            ...
            personalTitle.innerHTML = '<span class="material-symbols-outlined text-sm">person</span> Información Personal';
            ...
            phoneDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Teléfono</p>
            ...
            academicTitle.innerHTML = '<span class="material-symbols-outlined text-sm">school</span> Origen Académico';
            ...
            institucionDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Institución</p>
            ...
            paisDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">País</p>
            ...
            incorporationTitle.innerHTML = '<span class="material-symbols-outlined text-sm">science</span> Detalles de la Incorporación';
            ...
            finDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Fecha de Finalización</p>
        ...
        async function fetchEmployees() {
            try {
                ...
                if (!Array.isArray(json.employees)) throw new Error('Respuesta invÃ¡lida');
        ...
        function render() {
            ...
            groupEmployees.forEach((emp) => {
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 dark:text-slate-400">TelÃ©fono: ${emp.phone_prefix || '+34'} ${emp.phone_number || '000000000'}</p>
                </div>
            `;
            ...
            try {
                ...
                for (const upd of payload.updates) {
                    ...
                    if (startKey && endKey && endKey <= startKey) {
                        showToast('Hay una fecha fin igual o anterior al inicio. CorrÃ­gela antes de guardar.', 'error');
                        return;
                    }
                }
        ...
        async function fetchRequests() {
            try {
                ...
                const json = await resp.json();
                if (!Array.isArray(json.requests)) throw new Error('Respuesta invÃ¡lida');
        ...
        function renderRequests() {
            ...
            pendingRequests.forEach((req) => {
                ...
                details.innerHTML = `
                    ...
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        <p class="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-400">InstituciÃ³n</p>
                        <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">${req.institucion || '-'}</p>
                    </div>
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        <p class="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-400">PaÃ­s</p>
        ...
        (() => {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    ...
                    btnText.textContent = 'Guardar nueva contraseÃ±a';
                }
            });
        })();
    </script>
