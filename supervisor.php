...
<body class="bg-background-light dark:bg-background-dark min-h-screen text-slate-900 dark:text-slate-100">
        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-10 py-4 fixed top-0 left-0 right-0 z-50">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                    <button id="mobileMenuToggleSupervisor" type="button" class="md:hidden flex shrink-0 items-center justify-center overflow-hidden rounded-xl h-11 w-11 border border-primary bg-white dark:bg-slate-900 text-primary hover:bg-primary hover:text-white transition-colors" aria-label="Abrir menÃº">
                ...
                <div class="w-full max-w-[980px] flex flex-col gap-8">
                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-100 dark:border-slate-800 p-8">
                        <h3 class="text-primary text-sm font-bold uppercase tracking-wider mb-4 flex items-center gap-2">
                            ...
                            Actualizar contraseÃƒÂ±a / Update password
                        </h3>
                        <p class="text-sm text-slate-600 dark:text-slate-300 mb-4">Cambia tu contraseÃƒÂ±a de acceso. Debe tener al menos 6 caracteres. / Change your access password. It must be at least 6 characters.</p>
                        <form id="pwdInlineForm" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">ContraseÃƒÂ±a actual / Current password</label>
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Nueva contraseÃƒÂ±a / New password</label>
    ...
    <script>
        ...
        function renderSupervisorCard() {
            ...
            personalTitle.innerHTML = '<span class="material-symbols-outlined text-sm">person</span> InformaciÃƒÂ³n Personal / Personal Information';
            ...
            nombreDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.nombre || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            apellidosDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.apellidos || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            dniDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.dni_pasaporte || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            fechaNacDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.fecha_nacimiento || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            emailDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.email || 'Ã¢â‚¬â€'}</p>
            `;

            const phoneDiv = document.createElement('div');
            phoneDiv.className = 'rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-5';
            phoneDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">TelÃƒÂ©fono / Phone</p>
            ...
            academicTitle.innerHTML = '<span class="material-symbols-outlined text-sm">school</span> Origen AcadÃƒÂ©mico / Academic Background';
            ...
            institucionDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">InstituciÃƒÂ³n / Institution</p>
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.institucion || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            paisDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">PaÃƒÂ­s / Country</p>
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.pais || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            incorporationTitle.innerHTML = '<span class="material-symbols-outlined text-sm">science</span> Detalles de la IncorporaciÃƒÂ³n / Incorporation Details';
            ...
            motivoDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.motivo || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            inicioDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${formatDate(supervisorData.fecha_inicio) || 'Ã¢â‚¬â€'}</p>
            `;

            const finDiv = document.createElement('div');
            finDiv.className = 'rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-5';
            finDiv.innerHTML = `
                <p class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Fecha de FinalizaciÃƒÂ³n / End Date</p>
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${formatDate(supervisorData.fecha_fin) || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            grupoDiv.innerHTML = `
                ...
                <p class="mt-2 text-base font-semibold text-slate-900 dark:text-slate-100">${supervisorData.group_name || 'Ã¢â‚¬â€'}</p>
            `;
            ...
            pendingRequests.forEach((req) => {
                ...
                details.innerHTML = `
                    ...
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        ...
                        <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">${req.motivo || 'Ã¢â‚¬â€'}</p>
                    </div>
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                    ...
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        ...
                        <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">${req.institucion || 'Ã¢â‚¬â€'}</p>
                    </div>
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        <p class="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-400">PaÃƒÂ­s</p>
                        <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-slate-100">${req.pais || 'Ã¢â‚¬â€'}</p>
                    </div>
                    <div class="rounded-lg bg-slate-50 dark:bg-slate-950 p-3 border border-slate-200 dark:border-slate-800">
                        <p class="text-[10px] uppercase tracking-widest text-slate-500 dark:text-slate-400">Horario</p>
