    ...
    <main class="w-full max-w-xl bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl overflow-hidden flex flex-col relative" data-purpose="main-terminal-card">
        <section class="p-6 md:p-8 bg-white dark:bg-slate-900 flex flex-col relative" data-purpose="login-panel">
            ...
            <script>
                function switchLanguage(lang) {
                    const texts = {
                        es: {
                            title: 'IUBOLAB',
                            desc: 'App para el control de químicos. Ingresa tus credenciales para acceder.',
                        ...
                        en: {
                            title: 'IUBOLAB',
                            desc: 'Chemical control app. Enter your credentials to access.',
            ...
            <div class="mt-8 mb-10 text-center">
                ...
                <h2 class="text-3xl font-bold text-lab-primary mb-2">IUBOLAB</h2>
                <p class="text-slate-500">App para el control de químicos. Ingresa tus credenciales para acceder.</p>
            </div>
