        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-10 py-4 fixed top-0 left-0 right-0 z-50">
                ...
                <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                    <a href="/iubolab/quimicos.php" class="md:hidden flex shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-11 px-4 border border-primary text-primary text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary hover:text-white transition-colors">Químicos</a>
