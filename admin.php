...
<head>
    ...
    <title>IUBOLAB - AdministraciÃƒÂ³n</title>
        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 border-b border-solid border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 md:px-10 py-4 fixed top-0 left-0 right-0 z-50">
                <div class="flex items-center gap-3 flex-wrap">
                    ...
                    <h2 class="text-slate-900 dark:text-slate-100 text-lg font-bold leading-tight tracking-[-0.015em] border-l border-slate-300 dark:border-slate-700 pl-4">AdministraciÃƒÂ³n</h2>
                    <?php if ($fullName): ?>
                        <span class="text-sm text-slate-500 dark:text-slate-400 pl-4">Hola, <?php echo $fullName; ?></span>
                    <?php endif; ?>
                </div>
                <div class="flex items-center gap-3 w-full md:w-auto justify-end">
                    <a href="/iubolab/quimicos.php" class="md:hidden flex shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-11 px-4 border border-primary text-primary text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary hover:text-white transition-colors">QuÃ­micos</a>
                    ...
                    <div class="hidden md:flex items-center gap-3">
                        ...
                        <a href="/iubolab/quimicos.php" class="flex shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl h-11 px-4 border border-primary text-primary text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary hover:text-white transition-colors">QuÃ­micos</a>
                ...
                <div id="mobileMenuAdmin" class="hidden md:hidden w-full border-t border-slate-200 dark:border-slate-800 pt-3 flex flex-col gap-2">
                    ...
                    <a href="/iubolab/quimicos.php" class="w-full flex items-center justify-center rounded-xl h-11 border border-red-600 bg-red-600 text-white text-sm font-bold hover:bg-red-700 transition-colors">QuÃ­micos</a>
            ...
            <main class="flex-1 flex justify-center pt-36 md:pt-28 pb-10 px-4 md:px-0">
                <div class="w-full max-w-[980px] flex flex-col gap-6">
                    <div class="text-center">
                        <h1 class="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100">Panel de AdministraciÃƒÂ³n</h1>
            ...
            groupEmployees.forEach((emp) => {
                ...
                deleteButton.addEventListener('click', async () => {
                    const confirmed = await uiConfirm(
                        `Ã‚¿EstÃƒÆ’Ã‚¡s seguro que deseas borrar este usuario?\n${emp.nombre} ${emp.apellidos}\n\nLa acciÃƒÆ’Ã‚Â³n serÃƒÆ’Ã‚¡ permanente.`
                    );
                    if (!confirmed) return;
